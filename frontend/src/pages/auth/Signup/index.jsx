...
const SignupPage = () => {
  ...
  return (
    // Main container for the registration page, setting up full viewport height and flexible centering.
      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 p-8">
          ...
          <div className="mt-6 text-center">
            ...
            <button
              type="button"
              onClick={handleGoToLogin} // Changed to handleGoToLogin
