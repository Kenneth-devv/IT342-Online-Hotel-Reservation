...
const RegisterPage = ({ onSwitchToLogin }) => {  // Receive the prop for switching to login
  ...
  return (
    <div className="login-container" style={{ minHeight: '100vh', padding: '20px' }}>
      ...
      <div className="login-content" style={{ width: '100%', maxWidth: '500px', margin: '0 auto' }}>
        {/* Header */}
        ...
        {/* Registration Form */}
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 p-8" style={{ width: '100%' }}>
          ...
          <div className="mt-6 text-center">
            ...
            <button
                type="button"
                onClick={onSwitchToLogin}  // Use the prop here
