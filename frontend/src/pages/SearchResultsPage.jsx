  ...
  const allHotelListings = useMemo(() => [
    {
      ...
      location: 'Ayala Center, Cebu Business Park',
      city: 'Cebu City',
      description: 'A luxury hotel in the heart of Cebu City, near Ayala Center.',
      rating: 5,
      stars: 5,
      images: [
    ...
    },
    {
      ...
      location: '8th Avenue, Bonifacio Global City',
      city: 'Taguig',
      description: 'Modern luxury hotel in BGC, Manila.',
      rating: 5,
      stars: 5,
      images: [
    ...
    },
    {
      ...
      location: '30th Street, Bonifacio Global City',
      city: 'Taguig',
      description: 'Upscale hotel with extensive dining and recreation.',
      rating: 5,
      stars: 5,
      images: [
